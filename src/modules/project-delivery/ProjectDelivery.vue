<template>
  <section class="project-delivery">
    <header class="delivery-toolbar">
      ...
      <el-button class="dm-blue-action" type="primary" :loading="exporting" :disabled="!projectFiles.length" @click="downloadProject">
...
<style scoped>
.project-delivery{height:100%;min-height:0;display:grid;grid-template-rows:48px minmax(0,1fr);gap:10px;padding:10px;border:1px solid var(--dm-hairline);border-radius:var(--dm-radius-lg);background:linear-gradient(145deg,#0d0e0e,#090a0a)}
...
.delivery-grid{min-width:0;min-height:0;display:grid;grid-template-columns:320px minmax(500px,1fr) 440px;gap:10px}.delivery-panel{min-width:0;min-height:0;overflow:hidden;border:1px solid var(--dm-hairline);border-radius:var(--dm-radius-md);background:#101111}.panel-head{padding:16px 16px 12px}.panel-head h2,.project-structure h3,.summary-block h3,.integrity-block h3,.preview-block h3{margin:0;color:var(--dm-primary);font-size:16px;line-height:1.35}.panel-head p{display:flex;align-items:center;gap:5px;margin:6px 0 0;color:var(--dm-secondary);font-size:12px}
.local-panel{display:grid;grid-template-rows:auto auto minmax(0,1fr) auto}.permission-card{display:grid;gap:6px;margin:0 12px 8px;padding:10px 12px;border:1px solid var(--dm-hairline);border-radius:var(--dm-radius-sm);background:#151616}.permission-card.authorized{border-color:rgba(255,255,255,.16)}.permission-card>span{display:flex;align-items:center;gap:7px;color:#c8c8c3;font-size:12px}.permission-card small{overflow:hidden;color:var(--dm-secondary);font-family:"SFMono-Regular",Consolas,monospace;font-size:11px;text-overflow:ellipsis;white-space:nowrap}.tree-scroll,.table-scroll,.inspector-scroll{min-height:0}.tree-scroll{background:#101111}.tree-scroll :deep(.el-tree),.tree-scroll :deep(.el-scrollbar__view){background:#101111!important}.tree-scroll :deep(.el-tree){padding:2px 10px 10px;color:var(--dm-primary);--el-tree-node-hover-bg-color:rgba(255,255,255,.04);--el-tree-text-color:var(--dm-primary);--el-fill-color-blank:#101111}.tree-node{min-width:0;display:flex;align-items:center;gap:6px;color:var(--dm-primary);font-family:"SFMono-Regular",Consolas,monospace;font-size:11px}.tree-node>span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tree-node .el-icon{flex:none;color:#b7b7b0}
.project-structure{display:grid;gap:5px;margin:0 12px 12px;padding-top:10px;border-top:1px solid var(--dm-hairline)}.project-structure h3{margin-bottom:3px;font-size:14px}.project-structure button{min-width:0;min-height:30px;display:flex;align-items:center;justify-content:space-between;padding:5px 9px;border:1px solid transparent;border-radius:var(--dm-radius-sm);background:transparent;color:var(--dm-secondary);cursor:pointer}.project-structure button:hover,.project-structure button.active{border-color:var(--dm-hairline-strong);background:rgba(255,255,255,.055);color:var(--dm-tertiary)}.project-structure button span{display:flex;align-items:center;gap:8px}.project-structure small{font-family:"SFMono-Regular",Consolas,monospace;color:var(--dm-secondary)}
.list-panel{display:grid;grid-template-rows:auto minmax(0,1fr)}.list-head{display:flex;justify-content:space-between;gap:12px}.section-select{width:164px}.motion-table{min-height:0;display:grid;grid-template-rows:38px minmax(0,1fr) 42px}.motion-row{min-width:0;display:grid;grid-template-columns:28px minmax(110px,1.35fr) 84px 92px minmax(130px,1fr) 54px 60px;align-items:center;gap:8px;padding:0 12px}.table-head{border-block:1px solid var(--dm-hairline);color:var(--dm-primary);font-size:12px;font-weight:600}.motion-item{width:100%;height:60px;border:0;border-bottom:1px solid var(--dm-hairline);background:transparent;color:var(--dm-secondary);text-align:left;cursor:pointer}.motion-item:hover{background:rgba(255,255,255,.025)}.motion-item.active{padding-left:10px;border-left:2px solid var(--dm-tertiary);background:rgba(255,255,255,.045)}.motion-item strong,.motion-item>span{min-width:0;overflow:hidden;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.motion-item strong{color:var(--dm-primary)}input[type=checkbox]{width:14px;height:14px;margin:0;accent-color:var(--dm-tertiary)}.row-preview{height:42px;display:grid;place-items:center;overflow:hidden;border:1px solid rgba(255,255,255,.11);border-radius:4px;background:#080908;color:var(--dm-tertiary);font-family:"SFMono-Regular",Consolas,monospace;font-size:19px!important}.row-preview img{display:block;max-width:90%;max-height:74%;object-fit:contain}.row-preview b{font-weight:600}.ready i{width:6px;height:6px;display:inline-block;margin-right:6px;border-radius:50%;background:#b6b6b0}.motion-table footer{display:flex;align-items:center;padding:0 16px;color:var(--dm-secondary);font-size:12px}
