...
const loadingParams = {
  ...
  trackWidth: { key: "trackWidth", label: "轨道宽度", type: "number" as const, min: 120, max: 520, step: 10, unit: "px" },
...
export const decorationEffects: DecorationEffectTemplate[] = [
  ...
  },
  {
    ...
    section: "loading",
    subsection: "通用 Loading",
    description: "高亮光段沿低亮度轨道持续移动，也可以切换为确定进度展示。",
    scene: "页面顶部、面板数据、文件处理",
    defaultParams: {
      duration: 1.8,
    ...
    editableParams: [loadingParams.loopDuration, loadingParams.lineMode, loadingParams.progress, loadingParams.trackWidth, loadingParams.lineWidth, loadingParams.tailLength, loadingParams.radius, loadingParams.trackColor, loadingParams.color],
    previewType: "loading",
  ...
  },
  {
    ...
    section: "loading",
    subsection: "通用 Loading",
    description: "三层不规则闭合环以不同方向和节奏交错旋转，形成轻量的未来感加载状态。",
